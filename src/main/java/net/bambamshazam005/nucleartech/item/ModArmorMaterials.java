...
public enum ModArmorMaterials implements ArmorMaterial {
   STEELINGOT("steelingot", 21, new int[]{ 2, 6, 5, 2 }, 25,
            SoundEvents.ARMOR_EQUIP_IRON, .5f, 0.025f, () -> Ingredient.of(ModItems.STEELINGOT.get()));
    ...
    public String getName() {
        return NuclearTech.MOD_ID + ":" + this.name;
    }
